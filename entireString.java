/* a test to try read in whole text not just 1 line into string */

import java.io.*;
import java.util.*;

public class entireString{
	...
	public static void main(String [] args){
		...
		while (myFile.hasNextLine()) {
			String sen = myFile.next();
			myFile.useDelimiter("\\A"); //added in to skip new line characters and parse entire file 
